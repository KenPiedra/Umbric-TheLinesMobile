...
import { StyleSheet, TouchableWithoutFeedback, ColorValue, TextStyle, ViewStyle } from 'react-native';

import Colors from '../constants/Colors';
import useColorScheme from '../hooks/useColorScheme';
import { View, Text, ViewProps } from '../components/Themed';
import { ScrollableTabView, ScrollableTabBar } from 'react-native-scrollable-tab-view-ts';
...
export class NavigationTabBar extends ScrollableTabBar {
  ...
  renderTab = (name:string, page:number, isTabActive:boolean, onPressHandler:Function, onLayoutHandler:any) => {
    ...
    const borderStyle = {borderColor: activeTextColor, borderBottomWidth: isTabActive ? 4 : 1, height: isTabActive? 48 : 46};

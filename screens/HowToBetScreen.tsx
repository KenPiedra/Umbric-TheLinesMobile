        ...
        <View style={styles.contentWrap}>
          ...
          <View style={styles.infoWrap}>
            ...
            <View style={styles.infoText}>
              ...
              <Text style={styles.normalText}>
                (AKA Power Rating) – Creating a ranking score for each team so that a bettor, handicapper, or sportsbook can create a point spread. Experienced handicappers use their point spreads to compare with a sportsbook in order to find the best bets available.
              </Text>
            </View>
          </View>
          <View style={styles.infoWrap}>
          ...
          <View style={styles.infoWrap}>
            ...
            <View style={styles.infoText}>
              ...
              <Text style={styles.normalText}>
                ROI is an acronym for Return On Investment. The ROI of a sports wager can simply be calculated this way: (Gain from Investment – Cost of Investment) / Cost of Investment.
              </Text>
            </View>
          </View>
          <View style={styles.infoWrap}>
          ...
          <View style={styles.infoWrap}>
            ...
            <View style={styles.infoText}>
              ...
              <Text style={styles.normalText}>
                True odds are the actual odds of an event happening. In sports betting this is the most accurate point spread or moneyline.
              </Text>
            </View>
          </View>
          <View style={styles.infoWrap}>
